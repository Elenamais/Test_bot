...
token = '7123175906:AAGq0YTE8Nhlw-dmQZ_vWsk2AIkLPJl5gaI'
...
def save_voice_message(message):
    ...
    bot.reply_to(message, "Голосовое сообщение сконвертировано в WAV и сохранено в папку voice_messages")
...
def handle_photo_message(message):
    ...
    if detect_faces_in_photo(response.content):
        ...
        bot.send_message(message.chat.id, "Фото сохранено в папку photo_with_face")
    else:
        bot.send_message(message.chat.id, "На фото не обнаружены лица")
